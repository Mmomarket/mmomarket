  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12 space-y-6">
      ...
      <div className="flex items-center gap-5">
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-3xl font-bold text-white">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {profile.isVerified && (
              <span className="inline-flex items-center gap-1 text-xs bg-teal-900/50 text-teal-300 border border-teal-700/50 px-2 py-0.5 rounded-full font-medium">
                ✅ Verificado
              </span>
            )}
          </div>
